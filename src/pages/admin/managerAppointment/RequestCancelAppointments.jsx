...
const RequestCancelAppointments = () => {
  ...
  const statusKey = 'request_cancel';
  ...
  const fetchAppointments = async () => {
    ...
    try {
      ...
      const res = await axios.get("/admin/appointments/request-cancel", { params });
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-8">
        <h1 className="text-2xl font-bold mb-6">Quản lý lịch hẹn - Yêu cầu huỷ</h1>
...
export default RequestCancelAppointments; 