...
const WaitingPaymentAppointments = () => {
  ...
  const fetchAppointments = async () => {
    ...
    try {
      ...
      const res = await axios.get("/admin/appointments/waiting_payment", { params });
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-8">
        <h1 className="text-2xl font-bold mb-6">Quản lý lịch hẹn – Chờ thanh toán</h1>
            ...
            <table className="min-w-full border">
              ...
              <tbody>
                {appointments.length === 0 ? (
                  <tr>
                    <td colSpan={11} className="text-center py-4">Không có lịch hẹn</td>
                  </tr>
...
export default WaitingPaymentAppointments;
