            ...
            cart.items.map((item) =>
              item.product ? (
                <div
                  ...
                  className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-4 rounded-xl shadow min-h-[150px]"
                >
                  {/* Cột 1: Hình + tên + giá */}
                  <div className="flex items-center gap-4 flex-1 md:basis-1/2">
                    <img
                    ...
                    />
                    <div>
                      <h2 className="text-lg font-semibold text-gray-800 min-h-[48px] leading-snug">
                        {item.product.name}
                      </h2>
                      ...
                      <p className="text-sm text-gray-400">
                        Kho còn lại: {item.product.stock}
                      </p>
                    </div>
                  </div>

                  {/* Cột 2: Nút tăng/giảm số lượng + xoá */}
                  <div className="flex items-center gap-3 flex-wrap md:flex-nowrap md:basis-1/3 justify-center">
                    <button
                  ...
                  {/* Cột 3: Tổng giá */}
                  <div className="text-orange-600 text-lg font-bold whitespace-nowrap md:basis-1/6 text-right md:text-center">
